...
def main():
    ...
    # for k in vars(data_args):
    #     print(k)
    #     print(eval(f'data_args.{k}'))
    # exit(0)
    ...
    model = MTDNNModel(
        opt, device=device, state_dict=state_dict, num_train_step=num_all_batches, adapter_args=adapter_args, adapter=True, task_name='-'.join(list(tasks.keys()))
    )
    ...
    # # TEST
    # print('>>> Start SAVE...')
    # model_file = os.path.join(output_dir, "model_0.pt")

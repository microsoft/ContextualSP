#@title writefile models/mbart/mbartRATTypeNStructureSepForST.py
# coding=utf-8
...
class MBartRATEncoder(MBartPreTrainedModel):
    """
...
class MBartRATModel(MBartPreTrainedModel):
    def __init__(self, config: MBartConfig):
        super().__init__(config)
        ...
        self.encoder = MBartRATEncoder(config, self.shared)
...
class MBartRATTypeNStructureSepForST(MBartPreTrainedModel):
    base_model_prefix = "model"
    ...
    def __init__(self, config: MBartConfig):
        super().__init__(config)
        self.model = MBartRATModel(config)

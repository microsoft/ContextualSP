...
from matchzoo.modules import MultiHeadSelfAttention


class EsimTransformer(BaseModel):
    """
    ESIM Model.
    ...
    def build(self):
        ...
        self.input_encoding = StackedSelfAttention(
        ...
        self.projection = nn.Sequential(
            ...
            nn.ReLU())
        self.composition = StackedSelfAttention(
            self._params['hidden_size'],
            int(lstm_size / 2),
            self._params['lstm_layer'],
            dropout_rate=self._params['dropout'],

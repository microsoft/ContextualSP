...
1. **[Compositional Generalization by Learning Analytical Expressions](compositional_generalization)**(:hourglass_flowing_sand: To be Released on Oct. 2020)
...
1. **[Incomplete Utterance Rewriting as Semantic Segmentation](incomplete_utterance_rewriting)**(:hourglass_flowing_sand: To be Released on Oct. 2020)
...
1. **[{"What Do You Mean by That?" A Parser-Independent Interactive Approach for Enhancing Text-to-SQL](interactive_text_to_sql)**(:hourglass_flowing_sand: To be Released on Oct. 2020)
...
1. **[How Far are We from Effective Context Modeling ? An Exploratory Study on Semantic Parsing in Context](semantic_parsing_in_context)** (:coffee: Released on Apr. 2020)
